...
class TestQueryQueryFilter(unittest.TestCase):
    """QueryQueryFilter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryQueryFilter:
        """Test QueryQueryFilter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryQueryFilter`
        """
        model = QueryQueryFilter()
        if include_optional:
