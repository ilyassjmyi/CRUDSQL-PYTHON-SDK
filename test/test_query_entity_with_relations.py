...
class TestQueryEntityWithRelations(unittest.TestCase):
    """QueryEntityWithRelations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryEntityWithRelations:
        """Test QueryEntityWithRelations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryEntityWithRelations`
        """
        model = QueryEntityWithRelations()
        if include_optional:
    ...
    def testQueryEntityWithRelations(self):
        """Test QueryEntityWithRelations"""
