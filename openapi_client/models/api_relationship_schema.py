...
class ApiRelationshipSchema(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the relationship")
    related_model: Optional[StrictStr] = Field(default=None, description="Name of the related model", alias="relatedModel")
    type: Optional[StrictStr] = Field(default=None, description="Type of relationship (hasOne, hasMany)")
    __properties: ClassVar[List[str]] = ["name", "relatedModel", "type"]
