...
class QueryEntityWithRelations(BaseModel):
    """
    QueryEntityWithRelations
    """ # noqa: E501
    main_entity: Optional[Dict[str, Any]] = Field(default=None, alias="mainEntity")
    relations: Optional[Dict[str, List[Dict[str, Any]]]] = None
    __properties: ClassVar[List[str]] = ["mainEntity", "relations"]
